      ...
      <Row className='justify-content-center'>
        <Col sm={12}>
          <Content width='w-100' cssClassNames='bg-secondary'>
            <h4 className='p-3'>
              Formik Page <small>Component Testing</small>
            </h4>
          </Content>
